...
public partial class v_OCRD
{
    ...
    public decimal? ChecksBalL { get; set; }

    public decimal? ChecksBalS { get; set; }
    ...
    public string? DefCommDDt { get; set; }

    public short? DefCommMon { get; set; }

    public short? DefCommDay { get; set; }

    public DateTime? ExLettDate { get; set; }
